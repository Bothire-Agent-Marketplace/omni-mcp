...
export function ResourceFormDialog({
  ...
  useEffect(() => {
    if (formData.uri && !formData.mimeType) {
      ...
      if (uri.includes(".json")) detectedMimeType = "application/json";else
      if (uri.includes(".html")) detectedMimeType = "text/html";else
      if (uri.includes(".md")) detectedMimeType = "text/markdown";else
      if (uri.includes(".txt")) detectedMimeType = "text/plain";else
      if (uri.includes(".csv")) detectedMimeType = "text/csv";else
      if (uri.includes(".xml")) detectedMimeType = "application/xml";else
      if (uri.includes(".pdf")) detectedMimeType = "application/pdf";else
      if (uri.includes(".jpg") || uri.includes(".jpeg"))
      detectedMimeType = "image/jpeg";else
      if (uri.includes(".png")) detectedMimeType = "image/png";else
      if (uri.includes(".svg")) detectedMimeType = "image/svg+xml";
